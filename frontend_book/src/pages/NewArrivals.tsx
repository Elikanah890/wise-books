...
export default function NewArrivals() {
  ...
  const { books, pagination, loading, error } = useBooks({ page, limit: 12, sort: 'newest' });

  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center gap-4">
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 text-white">
